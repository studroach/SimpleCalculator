...
public class GuiInit {
	...
	public GuiInit(Compute calc) {
		...
		//this chunk initializes the GUI components
		...
		Layout();		//spaces everything correctly
		Listen(calc);	//makes the buttons work
	...
	public void Layout() {
		...
		//initializes the button properties by rows
	...
	public void Listen(Compute calc) {			//adds the listeners
		ActionListener number = new ActionListener() {		//creates the listener for numbers
			public void actionPerformed(ActionEvent e) {
				Compute.Insert(((AbstractButton) e.getSource()).getText(), ans, calc);
			}
		};
		
		ActionListener operator = new ActionListener() {	//creates the listener for operators
			public void actionPerformed(ActionEvent e) {
